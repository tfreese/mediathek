...
public final class MultimediaReporter
{
    ...
    */
     ...
     */
    static DataSource createBansheeSqLiteDataSource(final boolean readonly) throws Exception
    {
        return createSqLiteDataSource(readonly, "jdbc:sqlite:/home/tommy/.config/banshee-1/banshee.db");
    }
     ...
     * @throws Exception Falls was schief geht.
     */
    static DataSource createClementineSqLiteDataSource(final boolean readonly) throws Exception
    {
        return createSqLiteDataSource(readonly, "jdbc:sqlite:/home/tommy/.config/Clementine/clementine.db");
    }
     ...
     * @throws Exception Falls was schief geht.
     */
    static DataSource createKodiMusikSqLiteDataSource(final boolean readonly) throws Exception
    {
        return createSqLiteDataSource(readonly, "jdbc:sqlite:/home/tommy/.kodi/userdata/Database/MyMusic82.db");
    }
     ...
     * @throws Exception Falls was schief geht.
     */
    static DataSource createPlexSqliteDataSource(final boolean readonly) throws Exception
    {
        ...
        return createSqLiteDataSource(readonly, "jdbc:sqlite:/home/tommy/com.plexapp.plugins.library.db");
    }
     ...
     * @throws Exception Falls was schief geht.
     */
    private static DataSource createSqLiteDataSource(final boolean readonly, final String url) throws Exception
    {
    ...
    public static void main(final String[] args) throws Exception
    {
        ...
        DataSource dataSource = createClementineSqLiteDataSource(true);
        // DataSource dataSource = createKodiMusikSqLiteDataSource(true);
        STOP_WATCH.stop();
