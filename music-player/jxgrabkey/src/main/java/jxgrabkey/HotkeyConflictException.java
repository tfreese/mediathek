...
public class HotkeyConflictException extends Exception {
    @Serial
    private static final long serialVersionUID = 617721371057346948L;

    public HotkeyConflictException() {
        super();
    }

    public HotkeyConflictException(final String message) {
        super(message);
    }

    public HotkeyConflictException(final String message, final Throwable cause) {
        super(message, cause);
    }

    public HotkeyConflictException(final Throwable cause) {
        super(cause);
    }
}
