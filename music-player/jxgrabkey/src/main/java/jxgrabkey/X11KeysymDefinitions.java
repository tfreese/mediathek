...
/**
 * This class holds definitions for X11 keymaps. It can also convert AWT keys into X11 keymaps.
 *
...
public final class X11KeysymDefinitions {
     ...
     * right function keys; Sun keyboards and few other manufactures have
    ...
    /**
     * Converts an AWT key into an X11 keysym.
     */
    public static int awtKeyToX11Keysym(final int awtKey) {
        return switch (awtKey) {
            ...
            case KeyEvent.VK_SHIFT -> SHIFT_L;
            case KeyEvent.VK_CONTROL -> CONTROL_L;
            case KeyEvent.VK_ALT -> ALT_L;
            ...
            case KeyEvent.VK_0 -> NUM_0;
            case KeyEvent.VK_1 -> NUM_1;
            case KeyEvent.VK_2 -> NUM_2;
            case KeyEvent.VK_3 -> NUM_3;
            case KeyEvent.VK_4 -> NUM_4;
            case KeyEvent.VK_5 -> NUM_5;
            case KeyEvent.VK_6 -> NUM_6;
            case KeyEvent.VK_7 -> NUM_7;
            case KeyEvent.VK_8 -> NUM_8;
            case KeyEvent.VK_9 -> NUM_9;
            ...
            case KeyEvent.VK_OPEN_BRACKET -> BRACKET_LEFT;
            case KeyEvent.VK_BACK_SLASH -> BACKSLASH;
            case KeyEvent.VK_CLOSE_BRACKET -> BRACKET_LEFT;
            case KeyEvent.VK_NUMPAD0 -> KP_0;
            case KeyEvent.VK_NUMPAD1 -> KP_1;
            case KeyEvent.VK_NUMPAD2 -> KP_2;
            case KeyEvent.VK_NUMPAD3 -> KP_3;
            case KeyEvent.VK_NUMPAD4 -> KP_4;
            case KeyEvent.VK_NUMPAD5 -> KP_5;
            case KeyEvent.VK_NUMPAD6 -> KP_6;
            case KeyEvent.VK_NUMPAD7 -> KP_7;
            case KeyEvent.VK_NUMPAD8 -> KP_8;
            case KeyEvent.VK_NUMPAD9 -> KP_9;
            case KeyEvent.VK_MULTIPLY -> KP_MULTIPLY;
            case KeyEvent.VK_ADD -> KP_ADD;
            case KeyEvent.VK_SEPARATER -> KP_SEPARATOR;
            case KeyEvent.VK_SUBTRACT -> KP_SUBTRACT;
            case KeyEvent.VK_DECIMAL -> KP_DECIMAL;
            case KeyEvent.VK_DIVIDE -> KP_DIVIDE;
            ...
            case KeyEvent.VK_PRINTSCREEN -> PRINT;
            case KeyEvent.VK_INSERT -> INSERT;
            case KeyEvent.VK_HELP -> HELP;
            case KeyEvent.VK_META -> META_L;
            case KeyEvent.VK_BACK_QUOTE -> QUOTE_LEFT;
            case KeyEvent.VK_QUOTE -> QUOTE_RIGHT;
            ...
            case KeyEvent.VK_QUOTEDBL -> QUOTE_DBL;
            case KeyEvent.VK_LESS -> LESS;
            case KeyEvent.VK_GREATER -> GREATER;
            case KeyEvent.VK_BRACELEFT -> BRACE_LEFT;
            case KeyEvent.VK_BRACERIGHT -> BRACE_RIGHT;
            case KeyEvent.VK_AT -> AT;
            case KeyEvent.VK_COLON -> COLON;
            case KeyEvent.VK_CIRCUMFLEX -> ASCII_CIRCUM;
            case KeyEvent.VK_DOLLAR -> DOLLAR;
            case KeyEvent.VK_EURO_SIGN -> CURR_EURO;
            case KeyEvent.VK_EXCLAMATION_MARK -> EXCLAM;
            case KeyEvent.VK_INVERTED_EXCLAMATION_MARK -> EXCLAM_DOWN;
            case KeyEvent.VK_LEFT_PARENTHESIS -> PAREN_LEFT;
            case KeyEvent.VK_NUMBER_SIGN -> NUMBER_SIGN;
            case KeyEvent.VK_PLUS -> PLUS;
            case KeyEvent.VK_RIGHT_PARENTHESIS -> PAREN_RIGHT;
            case KeyEvent.VK_UNDERSCORE -> UNDERSCORE;
            case KeyEvent.VK_WINDOWS -> SUPER_L;
            case KeyEvent.VK_CONTEXT_MENU -> MENU;
            case KeyEvent.VK_FINAL -> 0; //????
            case KeyEvent.VK_CONVERT -> 0; //????
            case KeyEvent.VK_NONCONVERT -> 0; //????
            case KeyEvent.VK_ACCEPT -> 0; //????
            case KeyEvent.VK_MODECHANGE -> MODE_SWITCH;
            case KeyEvent.VK_KANA -> KANA_SHIFT;
            case KeyEvent.VK_KANJI -> KANJI;
            case KeyEvent.VK_ALPHANUMERIC -> EISU_SHIFT;
            case KeyEvent.VK_KATAKANA -> KATAKANA;
            case KeyEvent.VK_HIRAGANA -> HIRAGANA;
            case KeyEvent.VK_FULL_WIDTH -> 0; //????
            case KeyEvent.VK_HALF_WIDTH -> 0; //????
            case KeyEvent.VK_ROMAN_CHARACTERS -> 0; //????
            case KeyEvent.VK_ALL_CANDIDATES -> MULTIPLE_CANDIDATE;
            case KeyEvent.VK_PREVIOUS_CANDIDATE -> PREVIOUS_CANDIDATE;
            case KeyEvent.VK_CODE_INPUT -> CODEINPUT;
            case KeyEvent.VK_JAPANESE_KATAKANA -> KATAKANA;
            case KeyEvent.VK_JAPANESE_HIRAGANA -> HIRAGANA;
            case KeyEvent.VK_JAPANESE_ROMAN -> 0; //????
            case KeyEvent.VK_KANA_LOCK -> KANA_LOCK;
            case KeyEvent.VK_INPUT_METHOD_ON_OFF -> 0; //????
            case KeyEvent.VK_CUT -> 0; //????
            case KeyEvent.VK_COPY -> 0; //????
            case KeyEvent.VK_PASTE -> 0; //????
            case KeyEvent.VK_UNDO -> UNDO;
            case KeyEvent.VK_AGAIN -> REDO;
            case KeyEvent.VK_FIND -> FIND;
            case KeyEvent.VK_PROPS -> 0; //????
            case KeyEvent.VK_STOP -> CANCEL;
            case KeyEvent.VK_COMPOSE -> MULTI_KEY;
            case KeyEvent.VK_ALT_GRAPH -> 0; //????
            case KeyEvent.VK_BEGIN -> BEGIN;
            case KeyEvent.VK_UNDEFINED -> 0;
            default -> 0;
        };
    }
