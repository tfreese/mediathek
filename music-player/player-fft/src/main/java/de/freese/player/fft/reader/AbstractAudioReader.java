...
public abstract class AbstractAudioReader implements AudioReader {
    ...
    /**
     * FFT Parameters only used by SpectrumStream.
     */
    ...
    /**
     * Buffer used to store bytes as they are requested by SpectrumStream and replace them when they're no longer needed.
     */
